...
```{r Model Matrix}
df.model_matrix <- tibble(
  timepoint = rep(seq(1:3)-1, each = 5),
  treatment = rep(seq(1:5), times = 3)) %>%
  mutate(
...
ggarrange(
  ...
  plot_estimate_loadings(glmm_jackknife_results$Pa, glmm_jackknife_results$perc_a, 1),
  plot_estimate_loadings(glmm_jackknife_results$Pa, glmm_jackknife_results$perc_a, 2),
  plot_estimate_loadings(glmm_jackknife_results$Pab, glmm_jackknife_results$perc_ab, 1),
  plot_estimate_loadings(glmm_jackknife_results$Pab, glmm_jackknife_results$perc_ab, 2),
  ncol = 4,
  nrow = 2,
  common.legend = TRUE,
  labels = "AUTO",

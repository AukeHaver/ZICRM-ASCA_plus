...
ggarrange(
  ...
  glmm_jackknife_results$Tab %>% filter(PC==1)%>%
    ...
    labs(x="Timepoint",
         y=paste0("Scores PC1 (",
                  filter(glmm_jackknife_results$perc_ab,PC==1)$quantile_0.025 %>% round(1) %>% format(nsmall=1),
                  "-",
                  filter(glmm_jackknife_results$perc_ab,PC==1)$quantile_0.975 %>% round(1) %>% format(nsmall=1),
                  "%)"),
         color="Treatment Group")+
    theme(plot.title=element_text(hjust=.5),
        text=element_text(size=20),
  ...
  labs(x = "Variable",
       y=paste0("Loadings PC1 (",
                  filter(glmm_jackknife_results$perc_ab,PC==1)$quantile_0.025 %>% 
                  round(1) %>% 
                  format(nsmall=1),
                  "-",
                  filter(glmm_jackknife_results$perc_ab,PC==1)$quantile_0.975 %>% 
                  round(1) %>% 
                  format(nsmall=1),
                  "%)"))+
  theme(plot.title=element_text(hjust=.5),
  ...
  glmm_jackknife_results$Tab %>% filter(PC==2)%>%
    ...
    labs(x="Timepoint",
         y=paste0("Scores PC2 (",
                  filter(glmm_jackknife_results$perc_ab,PC==2)$quantile_0.025 %>% round(1) %>% format(nsmall=1),
                  "-",
                  filter(glmm_jackknife_results$perc_ab,PC==2)$quantile_0.975 %>% round(1) %>% format(nsmall=1),
                  "%)"),
       color = "Treatment Group")+
    theme(plot.title=element_text(hjust=.5),
        text=element_text(size=20),
